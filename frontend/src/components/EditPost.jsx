 ...
 * EditPost Component
 *
 * Este componente proporciona una interfaz para editar una publicación. Utiliza
 * Formik para gestionar el estado del formulario y React Query para realizar
 * la mutación de edición de la publicación.
 *
 * @component
 * @param {Object} props - Las propiedades del componente.
 * @param {Object} props.post - La publicación que se va a editar.
